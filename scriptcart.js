...
$(document).ready(function() {
    ...
    $(".add-to-cart").click(function() {
        var productTitle = $(".cart-title").text();
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const productWidth = productElements[0].offsetWidth + 50; // Including margin
    let currentIndex = 0;
    let autoSlideInterval;
    let autoSlideTimeout;

    // Clone the first few products and append them to the end
    ...
    function resetAutoSlide() {
        ...
        autoSlideTimeout = setTimeout(startAutoSlide, 3000); // Resume auto slide after 5 seconds
    }
